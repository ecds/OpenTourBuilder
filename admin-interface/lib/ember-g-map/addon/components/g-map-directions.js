...
export default GMapBase.extend({
  ...
  createFeature() {
    ...
    let route = {
      ...
      destination: {
        lat: get(this, 'destination_lat'),
        lng: get(this, 'destination_lng')
      },
      travelMode: get(this, 'travelMode') || 'WALKING'
    };

    if (
      get(this, 'waypoint_lat') &&
      get(this, 'waypoint_lng') &&
      get(this, 'travelMode') === 'DRIVING'
    ) {
      route['waypoints'] = [
        {
          location: {
            lat: get(this, 'waypoint_lat'),
            lng: get(this, 'waypoint_lng')
          },
          stopover: true
        }
      ];
